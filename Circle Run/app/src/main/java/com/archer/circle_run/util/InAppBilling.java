package com.archer.circle_run.util;
...
public class InAppBilling {
    ...
    public String getPublicKey()
    {
        String key[]=
                {
                        "1EQACKgCBIIMA8QACOAAFEQAB0w9GikhqkgBNAjIBIIM"
                                +"Awz/jJgV6caO9G3zycrIHIw1UQtjOBAcG"
                                + "MHqPUtJTABMUQSx8YeSKC8+eVTV4lzkIm"
                                + "uYqGrpqHyGRWnEDKdKxzEcXYRHqa9T"
                                +"WtETqKHKVoavitThLDgb2M2CeMvxD"
                                +"5IUs0BG6xjNq86o7TwbRtcxAxlLgqkPa"
                                +"wY+kGhPIs8bLhnnyL9oPnzyeKGge9DVbc"
                                +"sCQZJdg8z6Dx5txXByn8dDXuPSlkFA0Tr8v"
                                +"b4PfxJ9GKGKcfxqXzH2hDtckZ1LVQCmhGKFik"
                                +"amPS4ScgTi0mF1yYTcPvxYvldJKasjR"
                                +"o/fRrhNVY8sdEaJ4kTh9StVqEA"
                                +"Cwn87C1P6qJIxbCdWtRDps7QIDAQAB"
                };
