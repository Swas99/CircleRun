...
public class IabHelper {
    ...
    //Only one thread should be active at any time.
    Thread mThread;
    ...
    public void dispose() {
        ...
        if (mServiceConn != null) {
            if (mContext != null && mService!=null && mIsBound)
        ...
        try {
            ...
            if (token == null || token.equals("")) {
               logError("Can't consume "+ sku + ". No token.");
                Toast.makeText(mContext,"No Token",Toast.LENGTH_SHORT).show();
            ...
            if (response == BILLING_RESPONSE_RESULT_OK) {
               logDebug("Successfully consumed sku: " + sku);
                ...
                Toast.makeText(mContext,"Error consuming consuming sku ",Toast.LENGTH_SHORT).show();
               logDebug("Error consuming consuming sku " + sku + ". " + getResponseDesc(response));
               throw new IabException(response, "Error consuming sku " + sku);
            }
        }
        catch (RemoteException e) {
            Toast.makeText(mContext,"Remote exception while consuming. PurchaseInfo: ",Toast.LENGTH_SHORT).show();
