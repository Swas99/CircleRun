...
public class MainActivity extends Activity {
    ...
    public MathHelper objMathHelper;
    ...
    private void load_math_helper() {
        Runnable myRunnable = new Runnable(){
            public void run(){
                objMathHelper = new MathHelper();
                objMathHelper.compute_values();
            }
        };
    ...
    {
        new CountDownTimer(200000000000l, 3000) {
            @Override
